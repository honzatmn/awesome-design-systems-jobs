...
> A curated list of design systems jobs across the universe. We curate only jobs which promise to work on design systems. **All jobs on this list are regularly checked so there shouldn't be any inactive positions listed.**
...
|  | Company | Location |
|----------|---------|----------|
|[User Experience Design Lead](https://jobs.barnardos.org.uk/jobs/vacancy/user-experience-design-lead-3190/3181/description/)|
